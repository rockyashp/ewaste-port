...
const milestones = [
  ...
  {
    date: 'Week 3 — Video Based Task/Quiz',
    topic: 'E-Waste',
    desc: 'Had a quiz on E-Waste based on the video we watched in class, conducted through the Wayground platform. We also started Module 2, where we learned about Methods of Estimation.',
